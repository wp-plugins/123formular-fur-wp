...
function request($api_key) {
        ...
        $url = "http://www.123formular.de/wp_dispatcher.php";
...
<html>
	...
	if ($_POST["apikey"]) {    
		...
		?>
		<p>Please enter your 123Formular API Key.<br/> If you don't know it, <a href="http://www.123formular.de/index.php?p=login" target="_new">login</a> to 123Formular, then go to My Account.</p>
